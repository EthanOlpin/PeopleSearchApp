...
const Home = () => {
    ...
    return (
        <div>
            ...
            to connect to a remote database if desired.</p>
            <h2>Getting started</h2>
            <p>To begin, we can add some people to the database by selecting "Add People" from the navigation menu
            at the top of the screen. Once we have added one, or several, people to the database we can try searching for people
